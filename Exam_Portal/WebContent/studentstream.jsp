...
<div style="height:600px;
	...
	float:left;
	padding-top:50px;">
	<h3 align="center">Select Semester To View Student</h3>
<form action="showstudentstream.jsp">
<pre>
	<label style="margin-left:200px">Semester:</label><select  name="stream">
	...
	<input style="margin-left:500px" class="btn" type="submit" name="submit" value="submit">
</pre>
</form>
