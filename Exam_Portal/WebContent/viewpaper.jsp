...
<%
    ...
    if(rs.next())
    {
    	%>
    	<table>
    	<tr><th>EXAM</th><th>SUBJECT</th><th>CODE</th><th>DURATION</th><th>MAX-MARKS</th><th>VISIBLE</th></tr>
    	<%
    	do{
    		...
    		String visible=rs.getString("visible");
    			%>			
    				...
    				<td><%=maxmarks%></td>
    				<td><%=visible %></td>
    				<td><a href="viewcompletepaper.jsp?code=<%=code%>&name=<%=sub%>&exam=<%=exam%>">View</a></td>
