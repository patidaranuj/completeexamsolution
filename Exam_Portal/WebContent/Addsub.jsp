...
<div style="
	...
	float:left;
	padding-top:50px;" > 
<h3 align="center">enter  details for new course</h3>
<form action="Addsub">
<pre>
	<label style="margin-left:280px">Subject name:</label><input type="text" name="subname" >
	<label style="margin-left:280px">Subject code:</label><input type="text" name="subcode" >
	<label style="margin-left:280px">Stream:</label><input type="text" name="stream" >
