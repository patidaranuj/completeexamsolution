...
<%
	...
	String qr="select * from student where sem="+sem+" order by studentid";
	...
	<%
		...
		%></table>
		<form action="studentsem.jsp">
		<input class="btn" type="submit" value="back" style="float:right;margin-right:300px">
		</form>
		<%
	}
