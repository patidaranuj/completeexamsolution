...
<% 
	...
	%>
	<table border=1>
	<tr><th>Objective</th><th>Visibility</th><th>Change</th></tr>
	<% 
	if(rs.next())
	{
		do{
			...
			%>
			<tr><td><%=object %></td><td><%=visibility %></td><td><a href="Display?visibility=<%=visibility%>&object=<%=object %>">yes/no</a></td></tr>
