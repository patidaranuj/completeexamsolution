...
<div style="
	...
	float:left;
	padding-top:50px;">
	<h3 align="center">Enter Enrollment Number To View Student</h3>
<form action="showstudentenroll.jsp">
<pre>
	<label style="margin-left:200px">Student-Id:</label><input type="text" name="studentid">
	<input style="margin-left:460px" class="btn" type="submit" name="submit" value="submit">
</pre>
</form>
